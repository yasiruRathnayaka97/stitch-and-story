    ...
    <div className="about-container">
      <section className="hero-section">
        <div className="container mx-auto px-4 py-16 md:py-24">
          <h1 className="about-header">About Stitch and Story</h1>
          <p className="subtitle">Crafting quality textiles with passion since 2015</p>
        </div>
      </section>
      ...
      <section className="values-section">
        <div className="container mx-auto px-4 py-16 bg-light-color rounded-2xl">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="cta-content text-center">
            ...
            <p className="cta-text">
              Discover our collection of thoughtfully designed textiles and become part of our story.
            </p>
            <Link href="/routes/products" className="cta-button">
              Shop Now
            </Link>
          </div>
        </div>
